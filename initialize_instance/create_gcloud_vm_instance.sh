...
CPU_MACHINE="n1-standard-8" # compare with n1-standard-2 and n1-standard-4
...
gcloud compute instances create ${INSTANCE_NAME} \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=${INSTANCE_NAME},disk-resource-policy=projects/${PROJECT_ID}/regions/europe-west1/resourcePolicies/default-schedule-1,image=projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2404-noble-amd64-v20250701,mode=rw,size=200,type=pd-balanced \
